...
```python
 if arch == 'i386':
                return False
```
![在这里插入图片描述](https://cdn.jsdelivr.net/gh/fjh1997/CSDN@main/source/images/3e7a145427af583a92e75812f0748a13.png)
...
之后就可以愉快的动态调试了
64位
![在这里插入图片描述](https://cdn.jsdelivr.net/gh/fjh1997/CSDN@main/source/images/6a8545e1ee7bd4f95d5db6ab8584ef96.png)
32位
![在这里插入图片描述](https://cdn.jsdelivr.net/gh/fjh1997/CSDN@main/source/images/f17607cf81310ae7b8d2387fe3981a48.png)
