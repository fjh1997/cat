...
![在这里插入图片描述](https://cdn.jsdelivr.net/gh/fjh1997/CSDN@main/source/images/5439b02db4ae0a95de719626f20800dc.png)
里面的postinstall文件打开是这个样子：
![在这里插入图片描述](https://cdn.jsdelivr.net/gh/fjh1997/CSDN@main/source/images/29d6c81d931531f278a62a90d4eab4ce.png#pic_center)
通过对代码进行分析，由于macos的默认shell是zsh，所以环境变量在～/.zprofile里面。
去查看上述文件，破案了：
![在这里插入图片描述](https://cdn.jsdelivr.net/gh/fjh1997/CSDN@main/source/images/8681939ab4c06171c0a6802be3aefcea.png#pic_center)
