...
![在这里插入图片描述](https://cdn.jsdelivr.net/gh/fjh1997/CSDN@main/source/images/c41ec15c3acb290cd493db44e5577662.png)

换了无痕模式依然是这样，且组策略里面没有配置，怀疑是edge内置的列表。
打开edge://compat/enterprise可以看到有一个消费者网站列表。在该列表里面查到了https://mybank.icbc.com.cn。
![在这里插入图片描述](https://cdn.jsdelivr.net/gh/fjh1997/CSDN@main/source/images/280aa755b6f5e77b40e0b796ce2eaf7e.png)
