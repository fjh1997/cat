...
![在这里插入图片描述](https://cdn.jsdelivr.net/gh/fjh1997/CSDN@main/source/images/64dcf12c98397e7da173b0c9d44bf40d.png)
...
通过gdb调试发现，跳到这里就断了。
![在这里插入图片描述](https://cdn.jsdelivr.net/gh/fjh1997/CSDN@main/source/images/23ef1e998ef31eb8045330c7e3288af8.png)
我本地调试系统是ubuntu 18，在bin群里问了问，组长肥猫嘤嘤告诉我是xmm寄存器的问题，当glibc版本大于2.27的时候，系统调用system("/bin/sh")之前有个xmm寄存器使用。要确保rsp是与16对齐的，也就是末尾必须是0.
![在这里插入图片描述](https://cdn.jsdelivr.net/gh/fjh1997/CSDN@main/source/images/c14df87d598268b0f355bac35ae62984.jpeg)
![在这里插入图片描述](https://cdn.jsdelivr.net/gh/fjh1997/CSDN@main/source/images/cfa3a70fb1673f348f9c8eb0d5272ce8.jpeg)
由于xmm寄存器是128bit又用了movaps指令，故必须让rsp的地址能够整除16，解决方法就是少push一个寄存器。
![在这里插入图片描述](https://cdn.jsdelivr.net/gh/fjh1997/CSDN@main/source/images/f3359b58a8c19b8fecf74aa2d63f3a27.jpeg)
