...
![在这里插入图片描述](https://cdn.jsdelivr.net/gh/fjh1997/CSDN@main/source/images/3abae814ef661874ff154febc1967c53.png#pic_center)
...
![在这里插入图片描述](https://cdn.jsdelivr.net/gh/fjh1997/CSDN@main/source/images/804b387ca1e135af52fc849c8a20ce92.png#pic_center)
之后又从ZwContinue跳到了KiFastSystemCall
![在这里插入图片描述](https://cdn.jsdelivr.net/gh/fjh1997/CSDN@main/source/images/0032d276e7da375038bdd7d99937f844.png#pic_center)
...
![在这里插入图片描述](https://cdn.jsdelivr.net/gh/fjh1997/CSDN@main/source/images/0242f5c9c9541d88c9ef10b812e8c307.png)
我们使用命令`dd edi`看一下edi指向的结构体的内容：
![在这里插入图片描述](https://cdn.jsdelivr.net/gh/fjh1997/CSDN@main/source/images/bfa54e3c7d64d9e417d8db45ee74f7c1.png#pic_center)
...
![在这里插入图片描述](https://cdn.jsdelivr.net/gh/fjh1997/CSDN@main/source/images/6b7d8017d3be87fe4c3412ad05be9ca8.png#pic_center)

正确的下断点方法应该是断在栈上面的这个指针指向的地址，也就是使用命令`bp 7c8106f5`即可。
之后就可以愉快的继续从断点单步了：
![在这里插入图片描述](https://cdn.jsdelivr.net/gh/fjh1997/CSDN@main/source/images/d49d8010e41bb5022127b25cae262416.png#pic_center)
