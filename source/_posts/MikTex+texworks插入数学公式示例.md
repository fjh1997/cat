...
\end{document}
```
![在这里插入图片描述](https://cdn.jsdelivr.net/gh/fjh1997/CSDN@main/source/images/d1ac97178f27faf507624c3eaf958e5b.jpeg)
需要指出的是，第一句话指明本document所属的类，接下来的环境变量会从该类中寻找，而\begin{document}则是整个document的起点，相当于程序中的主函数main()
效果如下：
![在这里插入图片描述](https://cdn.jsdelivr.net/gh/fjh1997/CSDN@main/source/images/5c1195f29ec7ecb3057837685bbf8697.jpeg)
```latex
\documentclass{article}
\usepackage{amsmath}
%注意以上这个包要加上去
...
效果如下：
![在这里插入图片描述](https://cdn.jsdelivr.net/gh/fjh1997/CSDN@main/source/images/7739e0da198275cd725386a45a2c8fa5.jpeg)
