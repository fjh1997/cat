---
title: 关于黑苹果安装10.14 屏幕只显示部分区域且区域过小问题的解决方法（i7-6700+AMD vega56+微星MS-7996）
date: 2019-03-06 18:45:36
tags:
---

@[TOC](关于黑苹果安装10.14 屏幕只显示部分区域且区域过小问题的解决方法)
## 本人机器配置
...
如图
![屏幕问题](https://cdn.jsdelivr.net/gh/fjh1997/CSDN@main/source/images/5ed657ae66ad5260d281ea7e833e82f0.jpeg)
...
但是我依然遇到了如下问题。
![在这里插入图片描述](https://cdn.jsdelivr.net/gh/fjh1997/CSDN@main/source/images/e8cf9b95503d74219394aa0376c5d01c.jpeg)
...
这是十分重要的一步，打开bios，选择windows 操作系统的配置![在这里插入图片描述](https://cdn.jsdelivr.net/gh/fjh1997/CSDN@main/source/images/8cb2a4760e2f48bf22238cdc4b1b1a4c.jpeg)
在里面勾选Windows 8.1/10 WHQL支持，之后重启。

![在这里插入图片描述](https://cdn.jsdelivr.net/gh/fjh1997/CSDN@main/source/images/acdbaa2d47c010ada2e151a7002f42ef.jpeg)

重启之后，你会很惊讶的发现显示正常了。
## 安装结果
这是我安装好之后的结果，支持双屏。
![在这里插入图片描述](https://cdn.jsdelivr.net/gh/fjh1997/CSDN@main/source/images/9fce8b0de59dc31ef00f7096f31f418c.jpeg)
我的clover配置：
