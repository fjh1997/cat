---
title: 学习shell脚本的踩坑记以及windows/macos 网络唤醒的方案
abbrlink: 37784
url: /posts/37784.html
date: 2019-03-08 18:52:53
tags:
---

@[TOC](学习shell脚本的踩坑记以及windows/macos 网络唤醒的方案)
...
-  if [[ "aaa" !="aaa" ]]
-  if[[ "aaa" != "aaa" ]]
这四句比较字符串的shell命令，只有第一个是对的，其余几个都会出错，因为shell脚本的运行是吧每一个命令解析为程序+参数来运行的，甚至包括了[[这样的符号，这些符号都是作为参数运行的，所以参数与参数，与程序之间都要有**空格**分开，脚本才能顺利执行！
