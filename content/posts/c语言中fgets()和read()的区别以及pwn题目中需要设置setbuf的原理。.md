...
![在这里插入图片描述](/images/f52e27cd2639bbc583113c015140e85a.png)
![在这里插入图片描述](/images/bf75e89a172e7bb94b7cb7108d482d03.png)
...
![](/images/5c752d4c459de3566617012bf206915c.png)
![在这里插入图片描述](/images/c8d3385451077f9ea81723083694aaab.png)
可以看到系统调用read读入的buffer是用户空间指定的buffer，且read()函数仅仅为libc里面的sys_read系统调用的封装。
顺带一提 getchar()也是调用的read函数，调试如下：

![在这里插入图片描述](/images/793cc351f131a0bd694ded3aaa77be1e.png)
而我们在终端上发送ctrl+c的中断信号后，这个信号称为SIGINT也被read()读入，之后程序就会断在下一个位置：

![在这里插入图片描述](/images/ff25037888508c795d4886e7e1f49e38.png)
可以对比上图的0x40009112bc
...
![在这里插入图片描述](/images/1b59c6ded994a80b37162e991593262f.png)
...
![在这里插入图片描述](/images/d34d0611b27898042fc76c7f037e4984.png)
