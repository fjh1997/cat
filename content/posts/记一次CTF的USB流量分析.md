...
如下图：
![在这里插入图片描述](/images/4d4e90e2cecec84ccde32af472335958.jpeg)
...
```
但是这样的图像出来是反的。
![在这里插入图片描述](/images/02654372825fe969e4792584e70be12e.png)
...
![在这里插入图片描述](/images/10d4b7f130af96c3b7e6d70416041c61.png)
![在这里插入图片描述](/images/84a3549d974e998cc2bc2cf162d9dcef.png)
...
```
这下结果就比较接近了。
![在这里插入图片描述](/images/1b077a0301475580d15ce5e373f98979.jpeg)
流量详见附件：
...
![在这里插入图片描述](/images/d6381bc1faa60a3ec6767ad55a56002c.png)
再比如同样一个s没加shift是0000160000000000，加了shift之后是0200160000000000
![在这里插入图片描述](/images/1d6a591f4da560bca01a2412e4e033a7.png)

![在这里插入图片描述](/images/4486aaa260ff5d7ec713e94040045a73.png)
有些时候也会遇到多个按键一起按的情况，这个时候3～8字节可能会被利用起来。
![在这里插入图片描述](/images/713dc2f1cb24752817ee2202713dde41.png)
...
```
得到如下结果：
![在这里插入图片描述](/images/fb68e067bbf8de417bfda80f59add0cb.png)
