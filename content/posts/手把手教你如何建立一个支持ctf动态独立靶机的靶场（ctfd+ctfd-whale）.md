...
## 技术原理
先来看张图 = =
![](/images/6cc2ed78634911e2125fe8b22ef674b8.png)
...
![](/images/d19a081a477f48697269e60a384ebf7e.png)
 编辑frpc.ini
```bash
...
log_file = ./frpc.log
```
![](/images/be9ff1adc2133f4aa0117c4cccdc9114.png)
编辑完之后记得重启frpc容器
```bash
...
![](/images/c0c6f8d2ea1068cb334cf63d0fed349c.png)
填写相关参数，注意要在template里面写上frpc.ini的内容。里面domain填写自己的

![](/images/75a84077c839adb3a87d31f07418cd82.png)


![](/images/9380c0d8843a67458ae3a8dc6c3dbe7d.png)
![](/images/88eb28b57570ffe7bd31d34aa1be67c5.png)
由于我这篇文章写的比较早，ctfd-whale已经有了很多次更新，根据[gtfly](http://www.gtfly.top/)师傅的提醒，这里需要填写创建的网络。

![](/images/4e67740f39724ba8d71054318165ffad.png)
启动题目选择dynamic_docker

![](/images/c9538d3efc88c73beff65f0e6cef2c54.png)这里选择一个支持动态FLAG的docker镜像，并选择设置该docker镜像的内部端口

![](/images/cec42baeaa86e0701961938f71c6ab9a.png)内部端口可以用docker ps查看


![](/images/586a89d5c6d5e62494a5c4c50816195b.png)
...
![](/images/e0727f83637a384a665b468676ab252c.png)
![](/images/212877ac7848890ef2a39da46646ffa7.png)
### 5.制作支持动态flag的镜像
<br>请看gtfly写的
...
![](/images/7fc8f486a73a23b785acb8cbf5ed5c3f.png)
...
![](/images/cd5bd2dec7793c81b4cad8cd54b60a76.png)
下面教你怎么开启使用mlc登录的功能
首先注册并登录mlc

![](/images/944622bf4bb5a47a0187dc6ed147e4af.png)
选择create event

![](/images/42757272c4e9729555cd3ce17d86356a.png)
创建好了以后按照下面的方式填写相关信息

![](/images/602713f97aedd9324137bd6014acff20.png)
并把上面的Client ID和secret填写到ctfd的设置页面

![](/images/fd4748f19c183baf2a3057cb303e4a25.png)
之后就可以用mlc来登录了，当然登录的前提是用户已经注册mlc的账号，使用mlc账号登录的话会有一个official的标签如下：

![](/images/2d0018da4567291dd0eff4ef16f1a878.png)
