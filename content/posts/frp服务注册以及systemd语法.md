...
![在这里插入图片描述](/images/0586ab1c526d8c545a8ccf27607f7188.png)
打开之后，会发现文件夹里面有一些文件名为frps、或者是frps@，其实这些就是systemd注册的配置。
![在这里插入图片描述](/images/b0dd7649e53c3307467bbb43c44520c1.png)
点开查看如下

![在这里插入图片描述](/images/b1aec36403e0ed11b8dee1fdd47c0990.png)

![在这里插入图片描述](/images/383c585a42403a5ba0505f8e47e22397.png)可以看到frpc和frpc@文件里面只相差一个%i，我们可以从linux配置文件说明里找到这样做的理由。
