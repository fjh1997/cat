...
| **zip 下载（推荐 v0.1.1）** | [ctf-agent-dispatch-0.1.1.zip](https://github.com/fjh1997/ctf-agent-dispatch/releases/download/v0.1.1/ctf-agent-dispatch-0.1.1.zip) |
...
> 说明：不是「不需要 agents 配置」。v0.1.0 只放了 `agents/CLAUDE.md` 命名偏内部；**v0.1.1 起以根 `CLAUDE.md` + `.claude/agents/` 为准**。
