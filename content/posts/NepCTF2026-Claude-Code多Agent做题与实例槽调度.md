...
| **zip 下载（Release v0.1.0）** | [ctf-agent-dispatch-0.1.0.zip](https://github.com/fjh1997/ctf-agent-dispatch/releases/download/v0.1.0/ctf-agent-dispatch-0.1.0.zip) |
| Release 页 | [v0.1.0](https://github.com/fjh1997/ctf-agent-dispatch/releases/tag/v0.1.0) |
...
仓库内还包含：`agents/CLAUDE.md`（主会话运维宪法）、`bin/ctf-run-scoped`（MemoryMax=3G 包装）、`examples/nepctf2026.yaml`（接真实平台模板）。
