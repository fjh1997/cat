...
![在这里插入图片描述](/images/f53d430d2cf0da3cc4e9029c791758b1.png)
之后使用dism++恢复映像即可,注意不要勾选格式化，旧的文件会保留在windows.old.001文件夹里面。
![在这里插入图片描述](/images/68eb6c6c11279e1f1d0995b3f3a5a7a7.png)
![在这里插入图片描述](/images/5fda8de5cb28cfc411b1248f21ce6505.png)
